package com.pinechain.sampleapplication.core.presentation.activity

import androidx.appcompat.app.AppCompatActivity

// Here we add an abstraction layer so that we can write common functionality for all activities in the app.
